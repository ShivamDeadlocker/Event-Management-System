...
<div class="box box-primary">
  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
        <label for="exampleInputEmail1">Department</label> <!--changes shivam pro--> 
		<span id="sprytf_address">
        <textarea name="address" class="form-control input-sm" placeholder="Department name" id="address"></textarea>
		<span class="textareaRequiredMsg">Department name is required.</span>
		<span class="textareaMinCharsMsg">Department name must specify at least 5 characters.</span>	
		</span>
      </div>
	  <div class="form-group">
